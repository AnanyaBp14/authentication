...
initializePostgres(); // create tables and defaults
...
app.use(cors({ origin: [ "http://localhost:3000", "http://localhost:5173", "https://mochamist.onrender.com" ], credentials: true }));
